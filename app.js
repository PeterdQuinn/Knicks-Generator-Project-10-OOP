...
promptUser();
 ...
 var engineer = new Engineer("Phil Jackson", "11rings@email.com", "developer", "githubUsername");
 console.log(engineer.getName());

 var intern = new Intern("OBI skywalker toppin", "skywalker@email.com,", "intern", "Dayton");
 console.log(intern);

 var manager = new Manager("Tibbs", "KnicksCoach@email.com,", "manager", "123");
